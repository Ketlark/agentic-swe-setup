...
server.tool("get_docs", `Fetch up-to-date documentation for any library, framework, or API.
    ...
    try {
        ...
        if (isGitHubRef(trimmed)) {
            ...
            try {
                ...
                return {
                    content: [{ type: "text", text: `GitHub fetch failed: ${message}` }],
                    isError: true,
                };
            }
        }
        ...
        if (githubGuess) {
            ...
            try {
                ...
                return {
                    content: [{ type: "text", text: `[GitHub: ${githubGuess}]\n\n${content}` }],
                };
            }
            catch (err) {
                const message = err instanceof Error ? err.message : String(err);
